...
app.config['SECRET_KEY'] = 'crimzcraft'
app.config['SECURITY_REGISTERABLE'] = True
app.config['SECURITY_PASSWORD_SALT'] = 'crimzcraft'
...
class ExtendRegisterForm(RegisterForm):
    name = StringField('Minecraft Gamertag')
...
def index():
    ...
    if form.validate_on_submit():
        new_thread = Thread(title=form.title.data, description=form.description.data + f'\n\n - Posted By {current_user.username}', date_created=datetime.now())
...
@app.route('/discussion/<thread_id>', methods=['GET', 'POST'])
